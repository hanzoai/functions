...
// Admission webhooks can be added by adding tag: kubebuilder:webhook:path=/mutate-fission-io-v1-timetrigger,mutating=true,failurePolicy=fail,sideEffects=None,groups=hanzo.ai,resources=timetriggers,verbs=create;update,versions=v1,name=mtimetrigger.hanzo.ai,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-fission-io-v1-timetrigger,mutating=false,failurePolicy=fail,sideEffects=None,groups=hanzo.ai,resources=timetriggers,verbs=create;update,versions=v1,name=vtimetrigger.hanzo.ai,admissionReviewVersions=v1
