...
// Admission webhooks can be added by adding tag: kubebuilder:webhook:path=/mutate-fission-io-v1-function,mutating=true,failurePolicy=fail,sideEffects=None,groups=hanzo.ai,resources=functions,verbs=create;update,versions=v1,name=mfunction.hanzo.ai,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-fission-io-v1-function,mutating=false,failurePolicy=fail,sideEffects=None,groups=hanzo.ai,resources=functions,verbs=create;update,versions=v1,name=vfunction.hanzo.ai,admissionReviewVersions=v1
